...
all: $(OUTDIR)/codingame $(OUTDIR)/interactive $(OUTDIR)/generate_training_data_1 $(OUTDIR)/legal_move_test $(OUTDIR)/make_legal_move_test_data $(OUTDIR)/random_match othello_train/othello_train_cpp$(PYTHON_EXTENSION_SUFFIX)
clean:
